...
export default function Home({ data }) {
    const d = data.filter((data) => {
        return data.origin_station_code >= 7 && data.origin_station_code <= 8;
    })
    return (
        <div>
            ...
            <nav className={styles.nav}>
                <ul>
                    ...
                    <Link href="/UpcomingRides"><li>Upcoming rides (4)</li></Link>
                    <Link href="/PastRides"><li className={styles.ur}>Past rides (7)</li></Link>
                </ul>
